...
In addition to the standard library, several libraries are invented to aid the
...
parallel following the given dependency. This model is very intuitive and 
is sufficient to express most parallel patterns.
